...
class Plugin
{
	...
	public static function getSettings(GenericEvent $event)
	{
		...
		$settings->add_dropdown_setting(self::$module, __('Out of Stock'), 'outofstock_webhosting', __('Out Of Stock All Webhosting'), __('Enable/Disable Sales Of This Type'), $settings->get_setting('OUTOFSTOCK_WEBHOSTING'), ['0', '1'], ['No', 'Yes']);
		$settings->add_dropdown_setting(self::$module, __('Out of Stock'), 'outofstock_webhosting_demo', __('Out Of Stock Demo/Trial Webhosting'), __('Enable/Disable Sales Of This Type'), $settings->get_setting('OUTOFSTOCK_WEBHOSTING_DEMO'), ['0', '1'], ['No', 'Yes']);
		$settings->add_dropdown_setting(self::$module, __('Out of Stock'), 'outofstock_webhosting_ispconfig', __('Out Of Stock ISPconfig Webhosting'), __('Enable/Disable Sales Of This Type'), $settings->get_setting('OUTOFSTOCK_WEBHOSTING_ISPCONFIG'), ['0', '1'], ['No', 'Yes']);
		$settings->add_dropdown_setting(self::$module, __('Out of Stock'), 'outofstock_webhosting_ispmanager', __('Out Of Stock ISPmanager Webhosting'), __('Enable/Disable Sales Of This Type'), $settings->get_setting('OUTOFSTOCK_WEBHOSTING_ISPMANAGER'), ['0', '1'], ['No', 'Yes']);
		$settings->add_dropdown_setting(self::$module, __('Costs & Limits'), 'website_limited_package_enable', __('Enable a Daily Limited Package'), __('Enable/Disable Limiting of a website package'), (defined('WEBSITE_LIMITED_PACKAGE_ENABLE') ? WEBSITE_LIMITED_PACKAGE_ENABLE : '0'), ['0', '1'], ['No', 'Yes']);
		$settings->add_text_setting(self::$module, __('Costs & Limits'), 'website_limited_package', __('Daily Limited Package to Limit'), __('The Package ID to Limit per Day.'), (defined('WEBSITE_LIMITED_PACKAGE') ? WEBSITE_LIMITED_PACKAGE : 1003));
		$settings->add_text_setting(self::$module, __('Costs & Limits'), 'website_limited_package_limit', __('Daily Limited Package Limit'), __('How many packages can be sold per day.'), (defined('WEBSITE_LIMITED_PACKAGE_LIMIT') ? WEBSITE_LIMITED_PACKAGE_LIMIT : 100));
		$settings->add_text_setting(self::$module, __('Costs & Limits'), 'website_limited_package_multiplier', __('Daily Limited Sale Multiplier '), __('Each sale counts as this many towards this limit.'), (defined('WEBSITE_LIMITED_PACKAGE_MULTIPLIER') ? WEBSITE_LIMITED_PACKAGE_MULTIPLIER : 1));
		$settings->add_text_setting(self::$module, __('Webhosting Demo'), 'website_demo_expire_days', __('Days before Demo Expires'), __('How many days a webhosting demo will be active before expiring.'), (defined('WEBSITE_DEMO_EXPIRE_DAYS') ? WEBSITE_DEMO_EXPIRE_DAYS : 14));
		$settings->add_text_setting(self::$module, __('Webhosting Demo'), 'website_demo_warning_days', __('Days before Demo Sends Expiring Soon Mail'), __('How many days a webhosting demo will be active before sending out an expiring soon warning email.'), (defined('WEBSITE_DEMO_WARNING_DAYS') ? WEBSITE_DEMO_WARNING_DAYS : 10));
		$settings->add_text_setting(self::$module, __('Webhosting Demo'), 'website_demo_extend_days', __('Days the demo is extended when extending the demo'), __('How many days a webhosting demo will be active before sending out an expiring soon warning email.'), (defined('WEBSITE_DEMO_EXTEND_DAYS') ? WEBSITE_DEMO_EXTEND_DAYS : 10));
